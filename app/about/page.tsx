  ...
  return (
    <div className="relative overflow-x-hidden pb-28">
      ...
      <section className="relative px-4 pt-6 sm:px-6 lg:px-8">
        <div className="relative mx-auto max-w-6xl overflow-hidden rounded-[2rem] border border-white/50 shadow-[0_12px_48px_-12px_rgba(15,23,42,0.12)]">
          <Image
            src={HERO_IMAGE}
      ...
      <section className="relative mt-20 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-12 grid gap-6 lg:grid-cols-2 lg:gap-8">
            <RevealOnScroll>
              <div className="h-full overflow-hidden rounded-[1.75rem] border border-white/60 bg-gradient-to-b from-teal-50/50 to-white p-8 shadow-[0_8px_32px_-8px_rgba(15,23,42,0.07)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_16px_44px_-14px_rgba(15,23,42,0.12)]">
                <div
                ...
                />
                <h3 className="font-display text-xl font-semibold text-slate-900">What we do</h3>
            ...
            <RevealOnScroll delay={60}>
              <div className="relative h-full min-h-[280px] overflow-hidden rounded-[1.75rem] border border-white/50 shadow-[0_8px_32px_-8px_rgba(15,23,42,0.1)]">
                <Image
                  src={OVERVIEW_IMAGE}
      ...
      <section className="relative mt-20 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-6xl gap-6 md:grid-cols-2 md:gap-8">
          <RevealOnScroll>
            <div
              className="group relative h-full overflow-hidden rounded-[1.75rem] border border-white/50 p-8 shadow-[0_8px_40px_-12px_rgba(15,23,42,0.1)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_16px_48px_-14px_rgba(15,23,42,0.14)]"
              style={{
                background:
                  "linear-gradient(145deg, rgba(153,246,228,0.4) 0%, rgba(167,139,250,0.3) 60%, rgba(196,181,253,0.35) 100%)",
              }}
            >
              <div
              ...
              />
              <p className="font-mono text-[10px] font-semibold uppercase tracking-[0.28em] text-teal-800">
                Vision
              </p>
          ...
          <RevealOnScroll delay={70}>
            <div
              ...
              style={{
                background:
                  "linear-gradient(145deg, rgba(196,181,253,0.4) 0%, rgba(253,164,175,0.3) 60%, rgba(252,205,211,0.35) 100%)",
              }}
            >
              <div
                className="mb-6 h-10 w-10 rounded-full"
              ...
              />
              <p className="font-mono text-[10px] font-semibold uppercase tracking-[0.28em] text-violet-800">
                Mission
              </p>
              <h2 className="mt-3 font-display text-2xl font-bold text-slate-900 md:text-3xl">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            {leadership.map((person, i) => (
              <RevealOnScroll key={person.name} delay={i * 55}>
                <div
                  className={`group h-full overflow-hidden rounded-[1.75rem] border border-white/60 bg-gradient-to-b ${person.tint} p-8 shadow-[0_8px_32px_-8px_rgba(15,23,42,0.07)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_16px_44px_-14px_rgba(15,23,42,0.12)]`}
                >
                  <div className="flex gap-5">
                    <div
                      className="h-16 w-16 shrink-0 rounded-full ring-2 ring-white/60"
                      style={{
      ...
      {/* ─── Infrastructure ─── */}
      <section className="relative mt-20 px-4 sm:px-6 lg:px-8">
        <div className="relative mx-auto max-w-6xl overflow-hidden rounded-[2rem] border border-white/50 shadow-[0_12px_48px_-12px_rgba(15,23,42,0.14)]">
          <Image
            src={LAB_IMAGE}
      ...
      <section className="relative mt-20 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <RevealOnScroll>
            <p className="font-mono text-[11px] font-semibold uppercase tracking-[0.28em] text-rose-700">
              Compliance
            </p>
            <h2 className="mt-2 font-display text-3xl font-bold tracking-tight text-slate-950 md:text-4xl">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {complianceItems.map((item, i) => (
              <RevealOnScroll key={item.k} delay={i * 55}>
                <div
                  className={`h-full overflow-hidden rounded-[1.75rem] border border-white/60 bg-gradient-to-b ${item.tint} p-7 shadow-[0_6px_28px_-8px_rgba(15,23,42,0.07)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_16px_44px_-14px_rgba(15,23,42,0.12)]`}
                >
                  <div
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-slate-700">{item.v}</p>
                </div>
              </RevealOnScroll>
            ))}
          </div>
      ...
      <section className="relative mt-20 px-4 sm:px-6 lg:px-8">
        <RevealOnScroll>
          <div
            className="relative mx-auto max-w-6xl overflow-hidden rounded-[2.5rem] border border-white/40 p-10 text-center shadow-[0_16px_64px_-16px_rgba(15,23,42,0.14)] backdrop-blur-xl sm:p-14"
            style={{
              background:
