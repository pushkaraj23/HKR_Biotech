        ...
        <RevealOnScroll>
          <div className="relative overflow-hidden rounded-[2rem] border border-white/50 shadow-[0_12px_48px_-12px_rgba(15,23,42,0.12)]">
            ...
            <div className="relative px-8 py-14 sm:px-12 md:py-20 lg:max-w-[60%]">
              <p className="font-mono text-[11px] font-semibold uppercase tracking-[0.32em] text-violet-700">
                Sectors we serve
              </p>
              ...
              return (
                <RevealOnScroll key={ind.slug} delay={i * 70}>
                  <div id={ind.slug} className="scroll-mt-28 h-full">
                    <article
                      className={`group relative flex h-full flex-col overflow-hidden rounded-[1.75rem] border border-white/60 bg-gradient-to-b ${accent.tint} shadow-[0_8px_32px_-8px_rgba(15,23,42,0.07)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_48px_-16px_rgba(15,23,42,0.12)]`}
                    >
                      {/* Image strip */}
                      ...
                      <div className="relative flex flex-1 flex-col p-7 pt-4">
                        ...
                        <div className="relative flex flex-1 flex-col">
                          {/* Orb */}
                          <div
                            className="mb-4 h-10 w-10 rounded-full ring-2 ring-white/60"
                            style={{
