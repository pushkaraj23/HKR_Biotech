    ...
    <div className="relative overflow-x-hidden pb-28">
      ...
      <div className="relative z-10 mx-auto max-w-6xl space-y-12 px-4 pt-6 sm:px-6 md:space-y-16 lg:px-8">
        ...
        <nav className="text-sm text-slate-500">
          <Link href="/services" className="text-teal-800 transition hover:text-teal-950 hover:underline">
            Services
          </Link>
        ...
        {/* Hero — photo background with white wash */}
        <RevealOnScroll>
          <header className="relative overflow-hidden rounded-[2rem] border border-white/50 shadow-[0_12px_48px_-12px_rgba(15,23,42,0.12)]">
            <Image
            ...
            <div className="relative px-8 py-14 sm:px-12 md:py-20 lg:max-w-[60%]">
              ...
              <h1 className="mt-4 font-display text-3xl font-bold tracking-tight text-slate-950 sm:text-4xl md:text-5xl">
                {s.title}
              </h1>
            ...
            <ol className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {s.process.map((step, i) => (
                <RevealOnScroll key={step} delay={i * 60}>
                  <li className="flex gap-4 rounded-2xl border border-white/60 bg-white/60 p-5 shadow-sm backdrop-blur-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md">
                    <span
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <RevealOnScroll delay={60}>
            <section
              className="h-full rounded-[1.75rem] border border-white/60 bg-gradient-to-b from-violet-50/30 to-white p-7 shadow-[0_8px_32px_-8px_rgba(15,23,42,0.07)] backdrop-blur-xl"
            >
              <p className="font-mono text-[10px] font-semibold uppercase tracking-[0.28em] text-violet-700">
                Technical scope
              </p>
        ...
        <RevealOnScroll>
          <section>
            ...
            <h2 className="mt-2 font-display text-2xl font-bold tracking-tight text-slate-950 md:text-3xl">
              Other Services
            </h2>
              ...
              {relatedServices.map((rs, i) => (
                <RevealOnScroll key={rs.slug} delay={i * 50}>
                  <Link
                    ...
                    className="group block h-full rounded-[1.25rem] border border-white/60 bg-gradient-to-b from-white to-teal-50/20 p-5 shadow-[0_4px_16px_-6px_rgba(15,23,42,0.06)] backdrop-blur-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_8px_24px_-8px_rgba(15,23,42,0.1)]"
                  >
                    <h3 className="font-display text-sm font-semibold text-slate-900 transition-colors group-hover:text-teal-800">
                      {rs.title}
                    </h3>
                    <p className="mt-2 line-clamp-2 text-xs leading-relaxed text-slate-600">
                      {rs.summary}
                    </p>
                    <span className="mt-3 inline-flex text-xs font-semibold text-teal-700 transition-transform group-hover:translate-x-0.5">
                      Learn more →
                    </span>
                  </Link>
                </RevealOnScroll>
        ...
        {/* Enquiry form — pastel gradient matching hero */}
        <RevealOnScroll>
          <section
            id="enquiry-form"
            className="scroll-mt-28 relative overflow-hidden rounded-[2.5rem] border border-white/40 p-8 shadow-[0_16px_64px_-16px_rgba(15,23,42,0.14)] backdrop-blur-xl sm:p-12"
            style={{
              background:
                "linear-gradient(140deg, rgba(153,246,228,0.35) 0%, rgba(167,139,250,0.3) 35%, rgba(196,181,253,0.3) 55%, rgba(253,164,175,0.25) 100%)",
            }}
          >
            {/* Subtle grid */}
            <div
