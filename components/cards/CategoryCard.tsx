...
const CARD_ACCENTS = [
  ...
  {
    tint: "from-tint-primary/25 via-tint-accent/20 to-surface/80",
  ...
  {
    tint: "from-tint-accent/25 via-rose-950/20 to-surface/80",
    ...
    <Link href={`/products/${category.slug}`} className={cn("group block", className)}>
      ...
      >
        ...
        <div className="relative p-7">
          ...
          <p className="mt-3 text-sm leading-relaxed text-muted-foreground">{category.tagline}</p>
          <span
            className={cn(
