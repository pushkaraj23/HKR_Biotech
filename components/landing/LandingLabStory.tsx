...
const ACCENT_CLASSES = {
  ...
  danger: {
    bar: "from-danger to-primary-deep",
  },
};
...
export function LandingLabStory() {
  return (
    <section className="relative px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1.05fr_1fr] lg:items-center lg:gap-16">
        {/* Image side */}
        <RevealOnScroll className="relative order-2 lg:order-1">
          <div className="relative min-h-[420px] overflow-hidden rounded-[2rem] border border-border-strong/50 shadow-[var(--elev-card-stack)] sm:min-h-[500px]">
            <Image
              src={LAB_IMAGE}
        ...
        <div className="order-1 lg:order-2">
          <RevealOnScroll>
            ...
            >
              ...
              <h2 className="max-w-xl font-display text-3xl font-bold tracking-tight text-on-dark md:text-4xl">
                Infrastructure Built for <span className="text-primary-mid">Reproducibility</span>
              </h2>
              <p className="mt-4 max-w-xl text-base leading-relaxed text-on-dark/90 sm:text-lg">
            ...
            <ul className="mt-8 space-y-4">
              {FEATURES.map((f) => {
                ...
                return (
                  <li
                    key={f.title}
                    className="group flex gap-4 rounded-2xl border border-on-dark/22 bg-[rgba(18,25,35,0.5)] p-4 shadow-[0_10px_24px_-12px_rgba(18,25,35,0.65)] backdrop-blur-md transition-all hover:-translate-y-0.5 hover:border-on-dark/35 hover:bg-[rgba(18,25,35,0.62)] hover:shadow-[0_14px_30px_-12px_rgba(18,25,35,0.7)]"
                  >
                    <span
                      aria-hidden
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        <h3 className="font-display text-sm font-bold text-on-dark">
                          {f.title}
                        </h3>
                      </div>
                      <p className="mt-1 text-sm leading-relaxed text-on-dark/85">
                        {f.copy}
                      </p>
                    </div>
                  </li>
          ...
          <RevealOnScroll delay={180}>
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <ButtonLink
                href="/about"
                variant="secondary"
                className="rounded-full border-on-dark/35 bg-[rgba(18,25,35,0.46)] text-on-dark hover:border-on-dark/55 hover:bg-[rgba(18,25,35,0.62)]"
              >
                Company story
              </ButtonLink>
              <Link
                href="/contact"
                className="group inline-flex items-center gap-1.5 text-sm font-semibold text-primary-mid transition hover:text-primary"
              >
                Talk to us
                <span
                  aria-hidden
