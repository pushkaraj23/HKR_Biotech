  ...
  return (
    ...
    >
      ...
      <div className="relative px-8 py-12 md:px-12 md:py-14">
        ...
        <h1 className="mt-4 max-w-3xl font-display text-3xl font-bold tracking-tight text-on-dark sm:text-4xl md:text-5xl">
          {product.chemicalName}
        </h1>

        <p className="mt-5 max-w-2xl text-base leading-relaxed text-on-dark/85 md:text-lg">
        ...
        <dl className="mt-7 flex flex-wrap gap-2.5">
          {[
            ...
            >
              <span className="text-[10px] font-semibold uppercase tracking-[0.14em] text-on-dark/72">
                {item.label}
              </span>
