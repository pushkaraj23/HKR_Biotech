  ...
  return (
    ...
    >
      <div className="pointer-events-auto flex w-full max-w-lg gap-2 rounded-2xl border border-teal-200/80 bg-white/95 p-2 shadow-[0_-8px_32px_-8px_rgba(15,23,42,0.15)] backdrop-blur-md">
        <Link
          href="#enquiry"
          className="flex flex-1 items-center justify-center rounded-xl border border-slate-200 bg-white px-3 py-3 text-center text-xs font-semibold text-slate-900"
        >
          Details
        </Link>
        <EnquireGateLink
