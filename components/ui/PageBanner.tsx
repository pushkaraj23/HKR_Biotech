...
export function PageBanner({ title, description, className }: PageBannerProps) {
  return (
    <div
      className={cn(
        "relative overflow-hidden rounded-3xl border border-border-subtle bg-surface-glass-strong px-8 py-14 shadow-[0_4px_24px_-4px_rgba(0,0,0,0.2)] backdrop-blur-sm md:px-14 md:py-16",
        className,
      )}
    >
      <div
